...
const signals = [
  {
    ...
    note: "Core principle: reveal how systems work instead of obscuring them through hidden automation.",
  },
  {
    title: "Privacy by Design",
    note: "Offline-first, no telemetry. Privacy is a design requirement, not a feature toggle.",
  },
  {
    title: "User Autonomy",
    note: "Respect user control at every layer. Software should help understand, not silently override.",
  },
  {
    title: "System-Aligned",
    note: "Build with platforms, not against them. Integrate cleanly into existing system models.",
  },
  {
    title: "Long-Term Trust",
    note: "Prioritize correctness and clarity over rapid growth. Build software that ages well.",
  },
]
  ...
  return (
    <section id="signals" ref={sectionRef} className="relative py-32 pl-6 md:pl-28">
      ...
      <div ref={headerRef} className="mb-16 pr-6 md:pr-12">
        <span className="font-mono text-[10px] uppercase tracking-[0.3em] text-accent">01 / Philosophy</span>
