  ...
  const principles = [
    {
      number: "01",
      titleParts: [
        { text: "EXPLAIN", highlight: true },
        { text: " NOT CONTROL", highlight: false },
      ],
      description:
        "Help users understand system behavior instead of silently overriding it. Insight builds confidence; hidden automation erodes trust.",
      align: "left",
    },
    {
      number: "02",
      titleParts: [
        ...
        { text: " IS REQUIRED", highlight: false },
      ],
      description:
        "Privacy is not a feature toggle. Built offline-first, without telemetry, tracking, or hidden data flows.",
      align: "right",
    },
    {
      number: "03",
      ...
      description:
        "Build with platforms, not against them. Integrate cleanly into existing system models rather than bypassing or weakening them.",
      align: "left",
    },
    {
      number: "04",
      titleParts: [
        ...
        { text: "OVER GROWTH", highlight: true },
      ],
      description:
        "Prioritize correctness, clarity, and long-term reliability over rapid feature expansion or adoption metrics.",
      align: "right",
    },
  ]
  ...
  return (
    <section ref={sectionRef} id="principles" className="relative py-32 pl-6 md:pl-28 pr-6 md:pr-12">
      ...
      <div ref={headerRef} className="mb-24">
        ...
        <h2 className="mt-4 font-[var(--font-bebas)] text-5xl md:text-7xl tracking-tight">OUR PRINCIPLES</h2>
      </div>
