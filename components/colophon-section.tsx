  ...
  return (
    ...
    >
      ...
      <div ref={gridRef} className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-8 md:gap-12">
        ...
        <div className="col-span-1">
          ...
          <ul className="space-y-2">
            ...
            <li className="font-mono text-xs text-foreground/80">Control</li>
        ...
        <div className="col-span-1">
          ...
          <ul className="space-y-2">
            <li className="font-mono text-xs text-foreground/80">System Tools</li>
            <li className="font-mono text-xs text-foreground/80">Transparency</li>
            <li className="font-mono text-xs text-foreground/80">Privacy-First</li>
          </ul>
        </div>
        ...
        {/* Approach */}
        <div className="col-span-1">
          <h4 className="font-mono text-[9px] uppercase tracking-[0.3em] text-muted-foreground mb-4">Approach</h4>
          <ul className="space-y-2">
            ...
            <li className="font-mono text-xs text-foreground/80">Transparent</li>
          </ul>
        </div>
        ...
        <div className="col-span-1">
          ...
          <ul className="space-y-2">
            <li>
              <a
                href="https://github.com/pollux-studio"
            ...
            {/* <li>
              <a
                href="https://twitter.com/polluxstudio"
                className="font-mono text-xs text-foreground/80 hover:text-accent transition-colors duration-200"
              >
                X / Twitter
              </a>
        ...
        <div className="col-span-1">
          ...
          <ul className="space-y-2">
            <li className="font-mono text-xs text-foreground/80">{currentYear}</li>
      ...
      <div className="mt-24 mb-4">
        <Image
          src="/pollux-logo-white.png"
          alt="Pollux Studio Logo"
          width={128}
          height={128}
      ...
      >
        <p className="font-mono text-[10px] text-muted-foreground uppercase tracking-widest">
          © {currentYear} Pollux Studio. Open-source and community-driven.
        </p>
        <p className="font-mono text-[10px] text-muted-foreground">Good software earns trust through clarity.</p>
      </div>
    </section>
  )
}
